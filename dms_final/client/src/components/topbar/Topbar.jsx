...
export default function Topbar() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar className='appBar' position="fixed" sx={{ backgroundColor: 'rgba(0, 0, 0, 0.489)' }}>
        <Toolbar>
          <IconButton
            size="large"
            edge="start"
...
// const pages = ['Doctors', 'My Prescription', 'My Medicine'];
